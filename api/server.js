...
const uri = 'mongodb+srv://terorok543:HLhiR9uDICpaxv4d@infobraspres.onu7m.mongodb.net/?retryWrites=true&w=majority&appName=infobraspres';
...
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      ...
      styleSrc: ["'self'", "'unsafe-inline'", "https://stackpath.bootstrapcdn.com", "https://cdn.jsdelivr.net", "https://fonts.googleapis.com"], // Estilos permitidos
...
async function withDbConnection(operation) {
  ...
  try {
    ...
    const db = client.db('infobraspres');
    await operation(db);
  } catch (error) {
